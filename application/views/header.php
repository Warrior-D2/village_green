    ...
    <header id="blanco" class="row">
        <div class="col-12">
            <div id="bande3" class="row">
                <!-- ============== -->
                <div class="col-3 p-0">
                    <img id="logo" class="img-fluid" src="<?= base_url('assets/images/HEADER/logo_village_green.png'); ?>" alt="LOGO Village green">
                </div>
                ...
                placeholder="exemple@mail.fr">
                        ...
                        <a class="nav-link" href="#!"><img src="<?= base_url('assets/images/HEADER/picto_pays.png'); ?>" alt="logo pays"></a>
                    </nav>
                    <!-- nav2 -->
                    ...
                    <div class="row justify-content-between">
                        ...
                        <a href="" class="text-dark" title="">Autres Instruments à cordes pincées</a>' data-original-title="">Guit/Bass</a>
                            ...
                            <a href="#" role="button" title="" class="popovers  text-light" data-toggle="popover" data-html="true" data-trigger="focus" data-content='<a href="" title="test add link"></a>' data-original-title="">Eclairage</a>
                            <a href="#" role="button" title="" class="popovers  text-light" data-toggle="popover" data-html="true" data-trigger="focus" data-content='<a href="" title="test add link"></a>' data-original-title="">DJ</a>
                            <a href="#" role="button" title="" class="popovers  text-light" data-toggle="popover" data-html="true" data-trigger="focus" data-content='<a href="" title="test add link"></a>' data-original-title="">Cases</a>
                            <a href="#" role="button" title="" class="popovers  text-light" data-toggle="popover" data-html="true" data-trigger="focus" data-content='<a href="" title="test add link"></a>' data-original-title="">Accessoires</a>
                        </nav>
                    </div>
                    <!-- ============= -->
                </div>
