    ...
    <div class="container" id="blanco">
        <header>
            <div id="bande3" class="row">
                ...
                <div class="col-md-9 p-0 justify-content-end">
                    ...
                    <nav id="nav1" class="nav justify-content-end pt-1">
                        ...
                        data-trigger="focus" data-content='
                            ...
                            <label>E-mail :</label><input type="text" class="inpop" id="email" name="mail" placeholder="exemple@mail.fr">' 
                        ...
                        <a class="nav-link pr-3" href="#!"><img src="<?= base_url('assets/images/HEADER/picto_pays.png'); ?>" alt="logo pays"></a>
                    </nav>

                    <!--- 2nde bandes --->
                    <nav id="nav2" class="nav d-print-inline-flex justify-content-end p-0 pt-1">
                    ...
                    <!--- 3eme bandes --->
                    <nav id="nav3" class=" nav justify-content-end p-0 pt-12">
                        <a href="#!" role="button" title="" class="nav-link active popovers  text-light " data-toggle="popover" 
